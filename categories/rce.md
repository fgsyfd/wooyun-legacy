...
#### wooyun-2014-077978
**米聊2015APP远程代码执行漏洞+漏洞利用POC(可攻击指定用户)**
...
---
### [wooyun-2015-0106714] 中信银行信用卡客户端动卡空间存在远程调试界面
**厂商**: 中信银行 | **年份**: 2015 | **类型**: 远程代码执行
...
**详情**: 漏洞危害：动卡空间Android客户端用户能轻易设置“用户登录”调试界面，导致中信银行信用卡网站web API暴露，影响客户端安全性。成因分析：可能是开发人员把程序的测试版本错误地发布给用户。

**POC**: 1、从网站上下载并安装了动卡空间Android V3.3.13后，客户端会推送V3.4.2，直接安装升级。2、启动新的客户端V3.4.2，在主界面的“花瓣”菜单随便点一栏，例如“在线影院”，再点击手机的“menu键”，在弹出的菜单中选择“设置”， 客户端会出现了标题为“用户登录”的调试界面。3、在界面下部的众多按钮中随便点击，例如“生产”按钮，entry-1和server文本框就会显示相应的调试url，并弹出若干提示。部分url含有”Payment”，我怀疑跟中信银行的支付API有关。部分url以http为前缀，并无SSL加密。
...
---
### [wooyun-2015-0161450] 利辛农商银行某系统远程代码执行漏洞
**厂商**: 利辛农商银行 | **年份**: 2015 | **类型**: 成功的入侵事件
...
**详情**: joomla代码执行**.**.**.**     專利技術媒合平台 - 大葉大學 | 專利技術媒合平台**.**.**.**   大華科技大學崇德社**.**.**.**   http://**.**.**.**/    大華科技大學創意設計學位學程**.**.**.**   海事資訊科技系暨研究所
...
---
### [wooyun-2015-0145283] 深信服aSV漏洞第一弹之Remote Code Execution
**厂商**: 深信服 | **年份**: 2015 | **类型**: 远程代码执行
...
---
### [wooyun-2014-049946] 360安全浏览器Pad版远程代码执行漏洞
**厂商**: 奇虎360 | **年份**: 2014 | **类型**: 远程代码执行
...
---
### [wooyun-2015-0160347] 河北省联通公司某系统java反序列化漏洞导致服务器被入侵
**厂商**: 河北省联通公司 | **年份**: 2015 | **类型**: 成功的入侵事件
...
---
### [wooyun-2014-068662] 迅雷APP远程代码执行漏洞
...
**厂商**: 浙江电子口岸有限公司 | **年份**: 2015 | **类型**: 远程代码执行
...
---
### [wooyun-2012-012232] 香港航空代码执行
**厂商**: 香港航空 | **年份**: 2012 | **类型**: 系统/服务补丁不及时
...
---
### [wooyun-2014-068527] 赶集网远程代码执行漏洞(啥都有)
**厂商**: 赶集网 | **年份**: 2014 | **类型**: 远程代码执行
...
**厂商**: 华平信息技术股份有限公司 | **年份**: 2013 | **类型**: 远程代码执行
...
---
### [wooyun-2015-0109220] 爱奇艺客户端设计不当可能导致任意恶意程序执行漏洞（系统限制）
...
**详情**: 爱奇艺术万能播放器GeePlayer.exe存在dll劫持风险，SHPlayer.exe在启动时会加载opencl.dll，这个dll在本地不存在，如果黑客将上述格式的媒体文件加上上述对应的恶意dll打包放在一起，发给用户。用户打开上述格式文件，就会执行恶意程序，危害较大。
...
---
### [wooyun-2016-0169068] 北京某区政府采购网java反序列化漏洞
**厂商**: cncert国家互联网应急中心 | **年份**: 2016 | **类型**: 系统/服务补丁不及时
...
---
### [wooyun-2016-0167005] 方正集团某站点多个漏洞打包
**厂商**: 方正集团 | **年份**: 2016 | **类型**: 系统/服务补丁不及时
...
**详情**: 方正集团某站点漏洞打包站点：**.**.**.**:7001/newsedit/e5workspace/Login.jsp问题1：**.**.**.**:7001/console weblogic/weblogic问题2：JAVA反序列化漏洞

**POC**: 方正集团某站点漏洞打包站点：**.**.**.**:7001/newsedit/e5workspace/Login.jsp问题1：**.**.**.**:7001/console weblogic/weblogic问题2：JAVA反序列化漏洞
...
---
### [wooyun-2015-099276] 优酷客户端可被中间人攻击执行代码（利用条件较苛刻）
**厂商**: 优酷 | **年份**: 2015 | **类型**: 远程代码执行
...
---
### [wooyun-2015-0114116] 联想驱动安装插件可导致远程启动可执行恶意代码
**厂商**: 联想 | **年份**: 2015 | **类型**: 远程代码执行
...
---
### [wooyun-2010-0369] 中信证券网上交易安全控件存在远程溢出漏洞
**厂商**: 中信证券 | **年份**: 2010 | **类型**: 远程代码执行
...
**厂商**: 华富国际控股有限公司 | **年份**: 2012 | **类型**: 远程代码执行
...
**详情**: 华富财经网  是香港上市公司华富国际控股有限公司 (股份代号0952) 旗下的财经信息服务网站，于1998年成立﹔是香港首屈一指的财经信息网站，一直致力为机构性及个别投资者提供最有效的工具，让他们能在适当的时候作出决定。Quamnet以研究及分析港股市场为主，由多名专业的财经分析员撰写评论文章，网站的财经研究部更是全港最大，最专业的独立港股分析团队之一。
...
**厂商**: 云南省工商行政管理局 | **年份**: 2015 | **类型**: 成功的入侵事件
...
---
### [wooyun-2015-0103131] 中国银行控件代码注入可获取密码杀毒不报
**厂商**: 中国银行 | **年份**: 2015 | **类型**: 远程代码执行
...
---
### [wooyun-2015-0118241] 搜狐TV被挂马导致大量用户面临IE远程执行漏洞危险(一个由搜狐TV网站引起的血案)
**厂商**: 搜狐 | **年份**: 2015 | **类型**: 恶意信息传播
...
---
### [wooyun-2013-027592] 搜狐影音任意代码执行漏洞（附poc）
**厂商**: 搜狐 | **年份**: 2013 | **类型**: 远程代码执行
...
---
### [wooyun-2014-066523] 微米浏览器远程代码执行漏洞
**厂商**: 中兴通讯股份有限公司 | **年份**: 2014 | **类型**: 远程代码执行
...
---
### [wooyun-2016-0179538] 今日头条开放端口可导致远程在用户手机打开任意网站url
**厂商**: 字节跳动 | **年份**: 2016 | **类型**: 远程代码执行
...
---
### [wooyun-2015-097499] 360软件管家可导致中间人攻击执行任意代码（需要用户交互前提）
**厂商**: 奇虎360 | **年份**: 2015 | **类型**: 远程代码执行
...
---
### [wooyun-2015-0153353] wormhole第二弹来袭:360某应用可远程静默安装app
**厂商**: 奇虎360 | **年份**: 2015 | **类型**: 远程代码执行
...
---
### [wooyun-2014-066790] 联想旗下某浏览器代码执行
**厂商**: 联想 | **年份**: 2014 | **类型**: 远程代码执行
...
**厂商**: 中国铁建股份有限公司 | **年份**: 2016 | **类型**: 系统/服务补丁不及时
...
**详情**: 中国铁建股份有限公司电子商务平台Java反序列化漏洞(Weblogic)不如来个高rank吧？洞洞地址：**.**.**.**:8000/logonAction.do
...
---
### [wooyun-2015-0141355] 华为魔盒电视盒子遥控器App漏洞可导致被远程控制（需同局域网内）
**厂商**: 华为技术有限公司 | **年份**: 2015 | **类型**: 远程代码执行
...
**详情**: 为了方便用户控制电视盒子，华为开发了华为随心控app，用户可以安装在手机上通过它来控制电视盒子，物理遥控器的所有功能都可以通过这个app来实现。通过对该app发送的网络数据包进行分析以及逆向华为魔盒里的实现远程控制的后台服务程序安装包RemoteServer.apk得到了该apk对盒子的远程控制方式，从而实现了自己的虚拟机遥控器，再辅助电视盒子提供的蓝牙功能可以实现对电视盒子的远程控制和远程安装、启动app（攻击者须和电视盒子在同一个局域网内）。并通过编程模拟发送数据包实现了对华为盒子的远程控制
...
---
### [wooyun-2013-037838] 360手机浏览器远程代码执行漏洞（最新版本未修复）
**厂商**: 奇虎360 | **年份**: 2013 | **类型**: 远程代码执行
...
**厂商**: 北京国软易点软件技术有限公司 | **年份**: 2013 | **类型**: 远程代码执行
...
**厂商**: 北京锡恩企业管理顾问有限公司 | **年份**: 2013 | **类型**: 远程代码执行
...
---
### [wooyun-2015-098187] 华为手机自带浏览器跨域脚本执行漏洞（附poc）
**厂商**: 华为技术有限公司 | **年份**: 2015 | **类型**: 远程代码执行
...
**厂商**: 北京陌陌科技有限公司 | **年份**: 2014 | **类型**: 远程代码执行
...
---
### [wooyun-2015-092992] 搜狐新闻远程代码执行漏洞
**厂商**: 搜狐 | **年份**: 2015 | **类型**: 远程代码执行
...
**详情**: 搜狐新闻Android版导出2个js接口，可以导致远程代码执行漏洞
...
---
### [wooyun-2016-0191623] 亚信科技十台服务器沦陷/几百万运营商项目信息/全部员工个人信息/员工工资/SVN/邮件泄露
**厂商**: 亚信科技 | **年份**: 2016 | **类型**: 
...
---
### [wooyun-2015-0100071] 爱奇艺PPS影音设计不当(可劫持DLL)
**厂商**: 奇艺 | **年份**: 2015 | **类型**: 远程代码执行
...
**详情**: 爱奇艺PPS 影音和子程序（爱奇艺极速播放器）存在DLL劫持漏洞！当文件关联后，运行后缀名*.qsv 的播放文件时，可触发同目录下的恶意代码

**POC**: 爱奇艺PPS 影音和子程序（爱奇艺极速播放器）存在DLL劫持漏洞！当文件关联后，运行后缀名*.qsv 的播放文件时，可触发同目录下的恶意代码
...
---
### [wooyun-2013-020260] 多家单位深信服SSL VPN远程代码执行漏洞(补丁不及时)
...
---
### [wooyun-2014-066534] 迷人浏览器远程任意代码执行漏洞
**厂商**: 小米科技 | **年份**: 2014 | **类型**: 远程代码执行
...
---
### [wooyun-2013-017323] 深信服ssl vpn远程代码执行漏洞
**厂商**: 深信服 | **年份**: 2013 | **类型**: 设计不当
...
---
### [wooyun-2015-0107137] 苏宁易购Android客户端远程代码执行漏洞
**厂商**: 江苏苏宁易购电子商务有限公司 | **年份**: 2015 | **类型**: 远程代码执行
...
**详情**: 苏宁易购Android版导出2个js接口，可以导致远程代码执行漏洞
...
---
### [wooyun-2014-052026] 华为某款新手机默认浏览器远程代码执行漏洞
**厂商**: 华为技术有限公司 | **年份**: 2014 | **类型**: 远程代码执行
...
---
### [wooyun-2014-061543] 今日头条客户端远程代码执行
**厂商**: 字节跳动 | **年份**: 2014 | **类型**: 远程代码执行
...
---
### [wooyun-2015-090594] 深信服wan optimization controller广域网控制器存在bash漏洞
**厂商**: 深信服 | **年份**: 2015 | **类型**: 远程代码执行
...
---
### [wooyun-2016-0170106] 南京银行某系统存在weblogic反序列化漏洞
**厂商**: 南京银行 | **年份**: 2016 | **类型**: 系统/服务补丁不及时
...
---
### [wooyun-2015-0141866] 乐视视频PC客户端远程代码执行漏洞（附漏洞POC）
**厂商**: 乐视网 | **年份**: 2015 | **类型**: 远程代码执行
...
**详情**: 乐视视频PC客户端存在DLL劫持漏洞。当我们使用乐视视频打开一个视频时（比如Test.mp4），LeTVLoader.exe进程会尝试加载视频所在目录下的d3dcompiler_43.dll或者d3dcompiler_46.dll文件。如果将视频文件与恶意的DLL文件放在同一个目录下，打包发给受害者，受害者解压后打开视频就会中招。

**POC**: 首先，下载一个最新版本的乐视视频客户端（版本号为**.**.**.**），如下图所示：现在我们需要编译一个dll文件，代码如下（弹框提示证明DLL可以被加载）：#include <windows.h>BOOL WINAPI DllMain(HINSTANCE hinstDLL,DWORD fdwReason,LPVOID lpReserved ){switch( fdwReason ){case DLL_PROCESS_ATTACH:MessageBoxA(NULL,"DLL hijacking vulnerability detected.","Test",MB_ICONWARNING);b
...
**详情**: 1.铁岭市政府采购网存在java反序列化漏洞，可沦陷服务器，执行任意命令2.地址：**.**.**.**/   http://**.**.**.**/3.漏洞详细过程检测得知服务器为Weblogic服务器，发现存在Java反序列化漏洞，然后执行三条命令如下
...
**厂商**: 瀚蓝环境股份有限公司 | **年份**: 2016 | **类型**: 系统/服务补丁不及时
...
---
### [wooyun-2015-0164645] 江南农村商业银行某系统va反序列化漏洞
...
---
### [wooyun-2015-0132922] 民安财产保险有限公司某系统存在文件遍历
**厂商**: 民安财产保险有限公司 | **年份**: 2015 | **类型**: 任意文件遍历/下载
...
---
### [wooyun-2011-02751] 上海银行网银控件存在缓冲区溢出漏洞
**厂商**: 上海银行 | **年份**: 2011 | **类型**: 远程代码执行
...
---
### [wooyun-2015-0144933] 挖财理财记账Android客户端用户数据明文存储在本地数据库可被远程窃取
**厂商**: 杭州财米科技有限公司 | **年份**: 2015 | **类型**: 远程代码执行
...
---
### [wooyun-2014-064607] 中国航空集团公司某站任意代码执行
**厂商**: 中国航空集团公司 | **年份**: 2014 | **类型**: 系统/服务补丁不及时
