...
```
典型案例：wooyun-2015-0123377 唱吧服务器沦陷
...
```
典型案例：wooyun-2015-0120183 51信用卡管家
...
```
典型案例：wooyun-2015-0128813 良品铺子短信接口
...
| 案例ID | 标题 | 类型 | 利用链 |
|--------|------|------|--------|
| wooyun-2015-0123377 | 唱吧服务器沦陷 | 源码泄露 | 源码→配置→数据库→提权 |
| wooyun-2013-038850 | TOM SVN泄露 | 版本控制 | SVN→源码→SQL注入 |
| wooyun-2015-0120183 | 51信用卡管家 | 配置泄露 | 配置→MongoDB→数据 |
| wooyun-2015-0163955 | 黄金集团Session | 日志泄露 | 后台→日志→Session劫持 |
| wooyun-2015-0128813 | 良品铺子短信 | API泄露 | API→短信→账户接管 |
...
| wooyun-2015-0150430 | 吉祥航空信息 | 凭证泄露 | 邮箱→域密码→VPN |
| wooyun-2013-039470 | 联想备份文件 | 备份泄露 | data.zip→数据库配置 |
